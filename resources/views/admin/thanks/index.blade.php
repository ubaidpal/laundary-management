...
.ml-15{
  ...
  <div class="container-fuild ml-15">
   ...
   <form class="form-material" action="{{ route('thanks.update',1) }}" method="post" enctype="multipart/form-data"> 
    ...
    <div class="mainDiv">
        ...
        @foreach ($time as $item)
            ...
            <input type="text" name="input[{{$j}}][day]" value="{{ $item->name }}" style="width: 100%;" required />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Morning Start time:</label>
            <input type="time" name="input[{{$j}}][m_s_t]" value="{{ $item->m_s_t }}" style="width: 100%;" />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Morning End time:</label>
            <input type="time" name="input[{{$j}}][m_e_t]" value="{{ $item->m_e_t }}" style="width: 100%;"  />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Evening Start time:</label>
            <input type="time" name="input[{{$j}}][e_s_t]" value="{{ $item->e_s_t }}" style="width: 100%;" />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Evening End time:</label>
            <input type="time" name="input[{{$j}}][e_e_t]" value="{{ $item->e_e_t }}" style="width: 100%;"  />
            </div>
...
var variable = "{{count($time)}}" ;
    ...
    $('.addDiv').click(function(){
        ...
        $('.mainDiv').append(`
            ...
            <div class="form-group col-md-2">
            <label for="name">Day:</label>
            <input type="text" name="input[${variable}][day]" style="width: 100%;" required />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Morning Start time:</label>
            <input type="time" id=morning_start_time_`+rowid+` onblur="morningEndTime(`+rowid+`)" name="input[${variable}][m_s_t]" style="width: 100%;" required />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Morning End time:</label>
            <input type="time" id=morning_end_time_`+rowid+` name="input[${variable}][m_e_t]" style="width: 100%;" required />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Evening Start time:</label>
            <input type="time" id=evening_start_time_`+rowid+` onblur="eveningEndTime(`+rowid+`)" name="input[${variable}][e_s_t]" style="width: 100%;" required />
            </div>

            <div class="form-group col-md-2">
            <label for="name">Evening End time:</label>
            <input type="time" id=evening_end_time_`+rowid+` name="input[${variable}][e_e_t]" style="width: 100%;" required />
            </div>

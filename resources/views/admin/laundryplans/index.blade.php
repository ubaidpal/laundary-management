...
<div class="container-fuild">
    ...
    <div class="card-body">
    <div>
  <h2 class="pull-left">Manage Laundry Plans</h2>
    <a href="{{ route('laundryplans.single') }}" class="btn btn-primary pull-right mt-20">Add Plan</a>
    </div>
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
        ...
        <td>{{$details->price}}</td>
       <td>@if($details->status == 1)<a href="javascript:void(0)" data-userid="{{$details->id}}" data-status="0" data-url="{{ route('laundryplans.status') }}" class="text-success active_account">{{ 'Activated' }}</a> @else <a href="javascript:void(0)" data-userid="{{$details->id}}" data-status="1" data-url="{{ route('laundryplans.status') }}" class="text-danger inactive_account"> {{ 'Inactived' }} </a> @endif</td>
        <td>
            <a href="{{ route('laundryplans.showupdate', $details->id) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$details->id}}" data-url="{{ route('laundryplans.delete') }}"><i class="icon-trash text-default"></i> </a>
        </td>
      </tr>
    @endforeach
    </tbody>

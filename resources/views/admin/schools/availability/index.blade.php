...
<div class="container-fuild">
    ...
    <h2 class="pull-left">Manage Availability</h2>
  <a href="{{route('schools.single_vailability')}}" class="btn btn-primary pull-right mt-20">Add</a>
  </div>
  ...
  <table class="table" id=myTable>
    ...
    <tbody>
      ...
      ?>
        ...
        <td>
            <a href="{{ route('schools.availability_editForm', $details->id) }}"> <i class="mdi mdi-account-edit   text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$details->id}}" data-url="{{ route('schools.availability_delete') }}"><i class="icon-trash text-default"></i> </a>
        </td>
        </tr>
    @endforeach
    </tbody>

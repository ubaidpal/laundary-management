...
<div class="container-fuild">
    ...
    <div class="card-body">
    <div>
  <h2 class="pull-left">Manage overweight charges</h2>
    <!-- <a href="{{ route('laundrylogs.overweightsingle') }}" class="btn btn-primary pull-right mt-20">Add</a> -->
    </div>
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
        ...
        <tr>
        <td>1</td> 
        <td>{{$data->lbs_per_item}}</td> 
        <td>{{$data->charge}}</td> 

        <td>
            <a href="{{ route('laundrylogs.overweightshowupdate', $data->id) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
           <!--  <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$data->id}}" data-url="{{ route('laundrylogs.overweightdelete') }}"><i class="icon-trash text-default"></i> </a> -->
        </td>
      </tr>

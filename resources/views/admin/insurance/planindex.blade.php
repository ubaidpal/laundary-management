...
<div class="container-fuild">
    ...
    <h2 class="pull-left">Manage Insurance</h2>
  ...
  <table class="table" id=myTable>
    ...
    <tbody>
      ...
      @php $j =  1; @endphp
        ...
        @endforeach 
          <td>
            <a href="{{ route('insurance.planedit', $data->id) }}"> <i class="mdi mdi-account-edit   text-default"></i> </a>&nbsp;&nbsp;&nbsp;
           <!--  <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="" data-url="{{ route('insurance.delete') }}"><i class="icon-trash text-default"></i> </a> -->
        </td>
        </tr>

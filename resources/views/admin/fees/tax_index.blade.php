...
<div class="container-fuild">
    <div class="card">
      <div class="card-body">
        <div>
        <h2 class="pull-left">Manage Tax</h2>
          <!-- <a href="{{ route('tax_fees.single') }}" class="btn btn-primary pull-right mt-20">Add Tax</a> -->
        </div>
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
        ...
        <td>{{$j++}}</td>
         <td>{{$data->tax}}%</td>
        <td>{{$data->apply_services}}</td>
        <td>
            <a href="{{ route('tax_fees.update', $data->id) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            {{--<a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$data->id}}" data-url="{{ route('tax_fees.delete') }}" ><i class="icon-trash text-default"></i> </a>--}}
        </td>
      </tr>

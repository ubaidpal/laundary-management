...
<div class="container-fuild">
    ...
    <div class="card-body">
    <div>
  <h2 class="pull-left">Manage Addon Plans</h2>
    <a href="{{ route('addons.single') }}" class="btn btn-primary pull-right mt-20">Add Addon</a>
    </div>
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
      ...
      @foreach ($data as $details)
        ...
        <td>{{$details->price}}</td>
       <td>@if($details->status == 1)<a href="javascript:void(0)" data-userid="{{$details->id}}" data-status="0" data-url="{{ route('addons.status') }}" class="text-success active_account">{{ 'Activated' }}</a> @else <a href="javascript:void(0)" data-userid="{{$details->id}}" data-status="1" data-url="{{ route('addons.status') }}" class="text-danger inactive_account" > {{ 'Inactived' }} </a> @endif</td>
        <td>
            <a href="{{ route('addons.showupdate', $details->id) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$details->id}}" data-url="{{ route('addons.delete') }}"><i class="icon-trash text-default"></i> </a>
        </td>
      </tr>
    @endforeach
    </tbody>

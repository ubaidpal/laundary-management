...
<div class="container-fuild">
    <div class="card">
      <div class="card-body">
        <div>
        <h2 class="pull-left">{{ $data->type }} </h2>
          <?php if ($data->type == 'Laundry') {
             $type = $data->type;
          }elseif ($data->type == 'HouseKeeping') {
            $type = $data->type;
          }else{
            $type = $data->type;
          }
          ?>
          <a href="{{ route('how_it_work') }}" class="btn btn-primary pull-right mt-20">Go back</a>
        </div>
  ...
  <table class="table" id="myTable">
    ...
    <tbody>
        @php $j = 1; @endphp
      @foreach ($data->worksdetails as $details)
        ...
        <td>
            <a href="{{ route('how_it_work.edit', ['id'=>$details->id,'type'=>$data->type]) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            <!-- <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$details->id}}" data-type="{{ $data->type }}" data-url="{{ route('how_it_work.delete') }}" ><i class="icon-trash text-default"></i> </a> -->
        </td>
      </tr>
    @endforeach 
    </tbody>

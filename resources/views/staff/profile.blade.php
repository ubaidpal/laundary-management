...
<div class="container-fuild">
  ...
  <h2>My Profile</h2>
  <form class="form-material" method="post" action="{{route('staff.profile.update')}}" enctype="multipart/form-data">
    @csrf
    <div class="form-group">
      <label for="name">Image:</label><br>
      @if(isset($data->profile_image))
        <img id="blah" src="{{asset('images/staff_members').'/'.$data->profile_image}}" alt="your image" width="150" height="150">
      @else
    ...
    <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="{{ $data->first_name }}">
    </div>

...
<div class="container-fuild">
  ...
  <a href="{{route('staff.orders.all')}}" class="btn btn-default pull-right mt-20">Go Back</a>
  </div>
...
<tr>
    ...
    <td>
       @if(isset($data->plan->description)){{ $data->plan->description }} @endif( ${{$data->plan->price }}) 
    </td>
</tr>

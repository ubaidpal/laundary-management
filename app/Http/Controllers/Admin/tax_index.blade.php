  ...
  <table class="table" id="myTable">
    ...
    <tbody>
      ...
      @foreach ($data as $details)
        ...
        <td>
            <a href="{{ route('fees.update', $details->id) }}"> <i class="mdi mdi-account-edit text-default"></i> </a>&nbsp;&nbsp;&nbsp;
            <a class="delete deleteuserbutton" href="javascript:void(0)" data-userid="{{$details->id}}" data-url="{{ route('fees.delete') }}" ><i class="icon-trash text-default"></i> </a>
        </td>
      </tr>
    @endforeach 
    </tbody>
